...
func request_Scribe_WriteBatch_0(ctx context.Context, marshaler runtime.Marshaler, client ScribeClient, req *http.Request, pathParams map[string]string) (Scribe_WriteBatchClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.WriteBatch(ctx)
	if err != nil {
...
// RegisterScribeHandlerServer registers the http handlers for service Scribe to "mux".
// UnaryRPC     :call ScribeServer directly.
...
// RegisterScribeHandlerFromEndpoint is same as RegisterScribeHandler but
...
// RegisterScribeHandler registers the http handlers for service Scribe to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterScribeHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterScribeHandlerClient(ctx, mux, NewScribeClient(conn))
}

// RegisterScribeHandlerClient registers the http handlers for service Scribe
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ScribeClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ScribeClient"
...
func RegisterScribeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ScribeClient) error {
	mux.Handle(http.MethodPost, pattern_Scribe_WriteBatch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Scribe_WriteBatch_0(annotatedContext, inboundMarshaler, client, req, pathParams)
...
var (
	pattern_Scribe_WriteBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"aserto.scribe.v2.Scribe", "WriteBatch"}, ""))
)

var (
	forward_Scribe_WriteBatch_0 = runtime.ForwardResponseStream
)
