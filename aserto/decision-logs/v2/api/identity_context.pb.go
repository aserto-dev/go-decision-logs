...
const file_aserto_decision_logs_v2_api_identity_context_proto_rawDesc = "" +
	"\n" +
	"2aserto/decision-logs/v2/api/identity_context.proto\x12\x1aaserto.decisionlogs.api.v2\"k\n" +
	"\x0fIdentityContext\x12\x1a\n" +
	"\bidentity\x18\x01 \x01(\tR\bidentity\x12<\n" +
	"\x04type\x18\x02 \x01(\x0e2(.aserto.decisionlogs.api.v2.IdentityTypeR\x04type*o\n" +
	...
	"\x11IDENTITY_TYPE_JWT\x10\x03BeZFgithub.com/aserto-dev/go-decision-logs/aserto/decision-logs/v2/api;api\xaa\x02\x1aAserto.DecisionLogs.V2.APIb\x06proto3"

var (
	file_aserto_decision_logs_v2_api_identity_context_proto_rawDescOnce sync.Once
	file_aserto_decision_logs_v2_api_identity_context_proto_rawDescData []byte
)
...
func file_aserto_decision_logs_v2_api_identity_context_proto_rawDescGZIP() []byte {
	file_aserto_decision_logs_v2_api_identity_context_proto_rawDescOnce.Do(func() {
		file_aserto_decision_logs_v2_api_identity_context_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_aserto_decision_logs_v2_api_identity_context_proto_rawDesc), len(file_aserto_decision_logs_v2_api_identity_context_proto_rawDesc)))
	})
...
var file_aserto_decision_logs_v2_api_identity_context_proto_goTypes = []any{
...
func file_aserto_decision_logs_v2_api_identity_context_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aserto_decision_logs_v2_api_identity_context_proto_rawDesc), len(file_aserto_decision_logs_v2_api_identity_context_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
